export const ORCHESTRATOR_SYSTEM_PROMPT = `You are the orchestration agent for agent-orchestrator.
...
export const FINAL_REVIEW_SYSTEM_PROMPT = `You are the final reviewer.
