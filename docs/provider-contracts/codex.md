...
Status: experimental compatibility scaffolding. The Codex worker adapter is retained for future compatibility but is not part of the current release-supported npm/e2e worker path.
