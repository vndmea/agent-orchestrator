...
cw worker benchmark --suite coding-v1 --worker litellm:qwen3-coder --save
...
- `cw worker interview --save` is the onboarding step. It creates the persisted worker profile used for routing and safety gating.
