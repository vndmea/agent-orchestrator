...
- `client`, `opencode`, `claudecode`, and `codex` are experimental local CLI adapter paths with separate runtime contracts; they are not part of the current release-supported worker matrix.
