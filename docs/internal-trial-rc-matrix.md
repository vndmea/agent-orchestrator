...
Do not mark a gate complete without committed or attached evidence. For storage-aware gates, use user-scoped AO paths such as `~/.ao/workspaces/<workspace-id>/runs/<taskId>/report.md`.
...
| Artifact reader | `ao_read_task_artifact` can read at least one persisted task artifact from refs | [x] | `docs/evidence/deepseek-internal-trial-2026-06-26.md` |
